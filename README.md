...
*  Product categories (Mobiles, Laptops, Men, Women, Kids)
...
*  Payment simulation
*  Carousel banner using Swiper.js
...
1. Browse products from homepage or categories
2. Search products using search bar
3. Add items to cart
4. Manage quantity in cart
...
* Handling user authentication (basic)
